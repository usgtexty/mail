...
class SetupService {
	 ...
	 * @return Account|null
	 */
	public function createNewAccount($accountName, $emailAddress, $imapHost, $imapPort, $imapSslMode, $imapUser, $imapPassword, $smtpHost, $smtpPort, $smtpSslMode, $smtpUser, $smtpPassword, $uid, ?int $accountId = null, $oauthProvider = null, $oauthAccessToken = null, $oauthRefreshToken = null, $oauthIdToken = null, $oauthExpireIn = null): ?Account {
